...
const routes: Routes = [
  ...
  {path:"profile/:customerId/:buyTicketId", component:BuyTicketDetailComponent,canActivate:[LoginGuard]},
  {path:"trips/:tripId/buyTicket", component:BuyTicketComponent,canActivate:[LoginGuard]},
